        ...
        <div class="page search-page">
            ...
            <div class="content search-page__content">
                <div class="post style-block">
                    <form class="post__form" action="action="{{ url()->current() }}"" method="post" enctype="multipart/form-data">
                        @csrf
                        <label class="label">
                        ...
                        <label class="label">
                            <span>Теги</span>
                            <input class="input" placeholder="Введите теги через запятую" type="text">
                        </label>
                        <label class="label">
                            <span>Категория</span>
                        ...
                        <textarea class="input" name="content" minlength="300" maxlength="65000" rows="12" required></textarea>
                        @error('content')
                            <span class="_error">{{ $message }}</span>
                        @enderror
